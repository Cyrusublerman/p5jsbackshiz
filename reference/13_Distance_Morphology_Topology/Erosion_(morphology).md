...
where Bz is the translation of B by the vector z, i.e., $B_{z}=\{b+z\mid b\in B\}$, $\forall z\in E$.
...
The erosion of A by B is also given by the expression: $A\ominus B=\bigcap _{b\in B}A_{-b}$, where A−b denotes the translation of A by -b.
...
( f ⊖ b ) ( x ) = inf y ∈ B [ f ( x + y ) − b ( y ) ] {\displaystyle (f\ominus b)(x)=\inf _{y\in B}[f(x+y)-b(y)]} ,
